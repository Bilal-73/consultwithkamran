  ...
  return (
    <html lang="en" suppressHydrationWarning className={rootCssClass} style={{ colorScheme: resolvedScheme }}>
      <head>
        ...
        <meta name="keywords" content="consultation, business strategy, career coaching, leadership training, financial planning, professional consulting" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="Consult with Kamran" />
